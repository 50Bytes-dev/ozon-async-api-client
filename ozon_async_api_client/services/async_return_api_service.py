...
async def returns_company_fbsinfo(
    ...
    path = f"/v1/returns/company/fbs/info"
    headers = {
    ...
    async with aiohttp.ClientSession(headers=headers) as session:
        async with session.request("post", base_path + path, params=query_params, json=data.dict()) as inital_response:
            ...
            return (
                V1returnsCompanyFbsInfoResponse(**response)
                if response is not None
                else V1returnsCompanyFbsInfoResponse()
            )
...
async def return_api_giveout_is_enabled(
    ...
    base_path = api_config.base_path or ""
    path = f"/v1/return/giveout/is-enabled"
    headers = {
        "Content-Type": "application/json",
        "Accept": "application/json",
        "Authorization": f"Bearer { api_config.get_access_token() }",
...
async def return_api_giveout_get_barcode(
    ...
    base_path = api_config.base_path or ""
    path = f"/v1/return/giveout/barcode"
    headers = {
        "Content-Type": "application/json",
        "Accept": "application/json",
        "Authorization": f"Bearer { api_config.get_access_token() }",
...
async def return_api_giveout_get_pdf(
    ...
    base_path = api_config.base_path or ""
    path = f"/v1/return/giveout/get-pdf"
    headers = {
        "Content-Type": "application/json",
        "Accept": "application/json",
        "Authorization": f"Bearer { api_config.get_access_token() }",
...
async def return_api_giveout_get_png(
    ...
    base_path = api_config.base_path or ""
    path = f"/v1/return/giveout/get-png"
    headers = {
        "Content-Type": "application/json",
        "Accept": "application/json",
        "Authorization": f"Bearer { api_config.get_access_token() }",
...
async def return_api_giveout_barcode_reset(
    ...
    base_path = api_config.base_path or ""
    path = f"/v1/return/giveout/barcode-reset"
    headers = {
        "Content-Type": "application/json",
        "Accept": "application/json",
        "Authorization": f"Bearer { api_config.get_access_token() }",
