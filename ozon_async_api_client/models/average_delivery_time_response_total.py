...
from .v1average_delivery_time_response_orders_count import V1averageDeliveryTimeResponseOrdersCount


class AverageDeliveryTimeResponseTotal(BaseModel):
    """
    None model
    ...
    orders_count: Optional[V1averageDeliveryTimeResponseOrdersCount] = Field(alias="orders_count", default=None)
