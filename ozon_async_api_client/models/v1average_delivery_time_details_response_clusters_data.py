...
class V1averageDeliveryTimeDetailsResponseClustersData(BaseModel):
    """
    None model
    """

    another_delivery_time: Optional[List[Optional[V1averageDeliveryTimeDetailsResponseClustersDataAmnesty]]] = Field(
